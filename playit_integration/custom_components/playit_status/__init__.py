...
async def _setup_coordinator_and_maybe_sensors(
    ...
    # async_config_entry_first_refresh() ist nur für Coordinator-Instanzen mit ConfigEntry-Kontext gedacht.
    # Hier verwenden wir async_refresh() damit auch async_setup()/Legacy YAML zuverlässig funktioniert.
